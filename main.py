...
Bottom3.configure(background='#707070')

Bottom4 = Frame(root, width=400, height= 12.5, bd=1)
Bottom4.pack(side=BOTTOM)
Bottom4.configure(background='light blue')
...
lblRecognizerText= Label(Bottom4,font=('arial', 12), textvariable=label2, bd=1, relief='solid',bg='light blue')
